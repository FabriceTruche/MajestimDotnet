...
// Type: TenTec.Windows.iGridLib.Design.iGColorEmptyAsEmptyConverter
...
{
  internal class iGColorEmptyAsEmptyConverter : ColorConverter
  {
    public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
    {
      if (string.Compare(value as string, "Empty", true) == 0)
