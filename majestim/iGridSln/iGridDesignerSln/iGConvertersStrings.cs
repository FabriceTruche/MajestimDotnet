...
// Type: TenTec.Windows.iGridLib.Design.iGConvertersStrings
...
{
  internal class iGConvertersStrings
  {
    public const string cNotSet = "NotSet";
    public const string cEmpty = "Empty";
    public const string cCellStyle = "iGCellStyle";
    public const string cColHdrStyle = "iGColHdrStyle";
  }
}
