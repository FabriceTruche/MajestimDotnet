...
// Type: TenTec.Windows.iGridLib.Design.iGExceptionStrings
...
{
  internal class iGExceptionStrings
  {
    public const string cTextParseFailed = "Failed to parse Text";
    public const string cKeyAlreadyExists = "Key already exists";
  }
}
