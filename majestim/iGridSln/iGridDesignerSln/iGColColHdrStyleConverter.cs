...
// Type: TenTec.Windows.iGridLib.Design.iGColColHdrStyleConverter
...
{
  internal class iGColColHdrStyleConverter : iGStyleConverterBase
  {
    public iGColColHdrStyleConverter()
      : base(typeof (iGColHdrStyle), false)
    {
    }
  }
}
