...
// Type: TenTec.Windows.iGridLib.Design.iGCellStyleDesignConverter
...
{
  internal class iGCellStyleDesignConverter : iGStyleConverterBase
  {
    public iGCellStyleDesignConverter()
      : base(typeof (iGCellStyleDesign), true)
    {
    }
  }
}
