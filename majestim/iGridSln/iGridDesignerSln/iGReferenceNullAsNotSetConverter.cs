...
// Type: TenTec.Windows.iGridLib.Design.iGReferenceNullAsNotSetConverter
...
{
  internal class iGReferenceNullAsNotSetConverter : ReferenceConverter
  {
    public iGReferenceNullAsNotSetConverter(Type type)
      : base(type)
    {
    }
