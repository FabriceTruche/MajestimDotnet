...
// Type: TenTec.Windows.iGridLib.Design.iGColHdrStyleConverter
...
{
  internal class iGColHdrStyleConverter : iGStyleConverterBase
  {
    public iGColHdrStyleConverter()
      : base(typeof (iGColHdrStyle), true)
    {
    }
  }
}
