...
// Type: TenTec.Windows.iGridLib.Design.iGColHdrStyleDesignConverter
...
{
  internal class iGColHdrStyleDesignConverter : iGStyleConverterBase
  {
    public iGColHdrStyleDesignConverter()
      : base(typeof (iGColHdrStyleDesign), true)
    {
    }
  }
}
