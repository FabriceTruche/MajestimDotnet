...
// Type: TenTec.Windows.iGridLib.Design.iGColCellStyleConverter
...
{
  internal class iGColCellStyleConverter : iGStyleConverterBase
  {
    public iGColCellStyleConverter()
      : base(typeof (iGCellStyle), false)
    {
    }
  }
}
