...
// Type: TenTec.Windows.iGridLib.Design.iGDesignTimeDefaultColPatternConverter
...
{
  internal class iGDesignTimeDefaultColPatternConverter : iGExpandableTypeConverter
  {
    public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
    {
      if (destinationType == typeof (string))
        return (object) typeof (iGColPattern).Name;
