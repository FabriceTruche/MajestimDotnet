...
// Type: TenTec.Windows.iGridLib.iGColHdrMouseUpEventArgs
...
{
  /// <summary>Provides data for the <see cref="E:TenTec.Windows.iGridLib.iGrid.ColHdrMouseUp" /> event of an <see cref="T:TenTec.Windows.iGridLib.iGrid" /> control.</summary>
  public class iGColHdrMouseUpEventArgs : EventArgs
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="T:TenTec.Windows.iGridLib.iGColHdrMouseUpEventArgs" /> class.</summary>
    ...
    public iGColHdrMouseUpEventArgs(int rowIndex, int colIndex, iGColHdrKind kind, MouseButtons button, Rectangle bounds, Point mousePos, Keys modifierKeys, iGElemControl elemControl)
    {
